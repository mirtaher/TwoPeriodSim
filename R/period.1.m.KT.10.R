...
period.1.m.KT.10 <- function(i, r){
  ...
  eval_f_1_m <- function(c, i, r){
    return(list("objective" = - U(c[1], c[2])- beta * E.1.u.m(c[3], type = "U")[i,r] -
                  c[4] * ((1 + tau.d) * E.1.u.d(c[3], type = "u", spouse = "h")[i,r] - E.1.u.m(c[3], type = "u", spouse = "h")[i,r])  -
                  c[5] * log((-1) * ((1 + tau.d) * E.1.u.d(c[3], type = "u", spouse = "w")[i,r] - E.1.u.m(c[3], type = "u", spouse = "w")[i,r]))  , 
                "gradient" = c(-wt.h * u.grad(c[1]), 
                               -wt.w * u.grad(c[2]), 
                               (-beta) * E.1.u.m.der(c[3], type = "U")[i,r] - c[4] * ((1 + tau.d) * E.1.u.d.der(c[3], type = "u", spouse = "h")[i,r] - E.1.u.m.der(c[3], type = "u", spouse = "h")[i,r]) - c[5] * 1/((1 + tau.d) * E.1.u.d(c[3], type = "u", spouse = "w")[i,r] - E.1.u.m(c[3], type = "u", spouse = "w")[i,r])  *  ((1 + tau.d) * E.1.u.d.der(c[3], type = "u", spouse = "w")[i,r] - E.1.u.m.der(c[3], type = "u", spouse = "w")[i,r]),
                               (-1) * ((1 + tau.d) * E.1.u.d(c[3], type = "u", spouse = "h")[i,r] - E.1.u.m(c[3], type = "u", spouse = "h")[i,r]),
                               (-1) * log((-1) * ((1 + tau.d) * E.1.u.d(c[3], type = "u", spouse = "w")[i,r] - E.1.u.m(c[3], type = "u", spouse = "w")[i,r])) )
    )
    )
  ...
  while(cond) {
    ...
    if (si > s.length) stop("No feasible saving found")
      ...
      S0 <- s.seq[si]
      cond.w <- ifelse((1 + tau.d) * E.1.u.d(S0, type = "u", spouse = "w")[i,r] > E.1.u.m(S0, type = "u", spouse = "w")[i,r], 1, 0)
      cond <- cond.w
    }
  }
