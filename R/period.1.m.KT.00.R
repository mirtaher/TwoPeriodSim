  ...
  eval_f_1_m <- function(c, i, r){
    return(list("objective" = - U(c[1], c[2])- beta * E.1.u.m(c[3], type = "U")[i,r] -
                ...
                "gradient" = c(-wt.h * u.grad(c[1]), 
                               -wt.w * u.grad(c[2]), 
                               (-beta) * E.1.u.m.der(c[3], type = "U")[i,r] - c[4] * 1/((1 + tau.d) * E.1.u.d(c[3], type = "u", spouse = "h")[i,r] - E.1.u.m(c[3], type = "u", spouse = "h")[i,r]) * ((1 + tau.d) * E.1.u.d.der(c[3], type = "u", spouse = "h")[i,r] - E.1.u.m.der(c[3], type = "u", spouse = "h")[i,r]) - c[5] * 1/((1 + tau.d) * E.1.u.d(c[3], type = "u", spouse = "w")[i,r] - E.1.u.m(c[3], type = "u", spouse = "w")[i,r])  *  ((1 + tau.d) * E.1.u.d.der(c[3], type = "u", spouse = "w")[i,r] - E.1.u.m.der(c[3], type = "u", spouse = "w")[i,r]),
