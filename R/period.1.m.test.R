...
period.1.m.test <- function(i, r){
  ...
  eval_g_ineq <- function(c, i, r){
    c(E.1.u.d(c[3], type = "u", spouse = "h")[i,r] - E.1.u.m(c[3], type = "u", spouse = "h")[i,r],
      E.1.u.d(c[3], type = "u", spouse = "w")[i,r] - E.1.u.m(c[3], type = "u", spouse = "w")[i,r])
  }
  
  eval_jac_g_ineq <- function(c, i, r){
    matrix(c(0, 0, E.1.u.d.der(c[3], type = "u", spouse = "h")[i,r] - E.1.u.m.der(c[3], type = "u", spouse = "h")[i,r],
      0, 0, E.1.u.d.der(c[3], type = "u", spouse = "w")[i,r] - E.1.u.m.der(c[3], type = "u", spouse = "w")[i,r]) , ncol = 2)
  }
