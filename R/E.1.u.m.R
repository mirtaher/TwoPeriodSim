#' Expected Second Period Marriage Utility Given The First Period Info
#'
#' This function calculates the expected second period marriage utility given the information revealed at the first period for a given level of savings for an individual family.
