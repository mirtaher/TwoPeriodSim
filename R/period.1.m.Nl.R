...
period.1.m.Nl <- function(i, r, pc = FALSE){
  library(nloptr)
  ...
  heqjac <- function(c, i, r) c(1, 1, 1)
  
  # without participation constraints
  hin <- function(c, i, r) c( c[1], c[2])
  hinjac <- function(c, i, r) diag(2)
  
  if (pc){
    hin <- function(c, i, r) c(E.1.u.m(c[3], type = "u", spouse = "h")[i,r] - E.1.u.d(c[3], type = "u", spouse = "h")[i,r],
                               E.1.u.m(c[3], type = "u", spouse = "w")[i,r] - E.1.u.d(c[3], type = "u", spouse = "w")[i,r], 
                               c[1],
                               c[2])
    hinjac <- function(c, i, r) matrix(c(0, 0, 1, 0,
                                          0, 0, 0, 1, 
                                          E.1.u.m.der(c[3], type = "u", spouse = "h")[i,r] - E.1.u.d.der(c[3], type = "u", spouse = "h")[i,r],
                                          E.1.u.m.der(c[3], type = "u", spouse = "w")[i,r] - E.1.u.d.der(c[3], type = "u", spouse = "w")[i,r],
                                          0,
                                          0), ncol = 3)
  }
  ...
  res <- nloptr::auglag(par = c0, fn = fn, gr = gr, heq = heq, heqjac = heqjac, hin = hin, hinjac = hinjac, i = i, r = r)
  
  return(list("sol" = res$par))
}