...
period.1.m.test.tax <- function(i, r){
  library(nloptr)
  ...
  eval_g_ineq <- function(c, i, r){
    c((1 + tau.d) * E.1.u.d(c[3], type = "u", spouse = "h")[i,r] - E.1.u.m(c[3], type = "u", spouse = "h")[i,r],
      (1 + tau.d) * E.1.u.d(c[3], type = "u", spouse = "w")[i,r] - E.1.u.m(c[3], type = "u", spouse = "w")[i,r])
  }
  
  eval_jac_g_ineq <- function(c, i, r){
    matrix(c(0, 0, (1 + tau.d) * E.1.u.d.der(c[3], type = "u", spouse = "h")[i,r] - E.1.u.m.der(c[3], type = "u", spouse = "h")[i,r],
             0, 0, (1 + tau.d) * E.1.u.d.der(c[3], type = "u", spouse = "w")[i,r] - E.1.u.m.der(c[3], type = "u", spouse = "w")[i,r]) , ncol = 2)
  }
