...
period.1.m.KT.11 <- function(i, r){
  ...
  eval_f_1_m <- function(c, i, r){
    return(list("objective" = - U(c[1], c[2])- beta * E.1.u.m(c[3], type = "U")[i,r] -
                ...
                "gradient" = c(-wt.h * u.grad(c[1]), 
                               -wt.w * u.grad(c[2]), 
                               (-beta) * E.1.u.m.der(c[3], type = "U")[i,r] - c[4] * ((1 + tau.d) * E.1.u.d.der(c[3], type = "u", spouse = "h")[i,r] - E.1.u.m.der(c[3], type = "u", spouse = "h")[i,r]) - c[5] * ((1 + tau.d) * E.1.u.d.der(c[3], type = "u", spouse = "w")[i,r] - E.1.u.m.der(c[3], type = "u", spouse = "w")[i,r]),
  ...
  if (equal < 0) {
    ...
    c0 <- c(equal.neg, equal.neg, 0, 0, 0)
  }
  else{
    c0 <- c(equal, equal, 0, 0, 0)
  }
