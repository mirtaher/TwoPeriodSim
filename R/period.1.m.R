#' The First Period Problem Given Decision to Stay Married in the Second Period
#'
#' This function find the optimal spouses' consumption levels and saving given the fact that they know that they are going to stay married in the following period.
#' The decision to divorce shows itself in the expected next period utility in the objective function; we use E.1.u.m as opposed to E.1.u.d
#'
